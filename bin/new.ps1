                                                                                               ...
                                                                                               # Define their path in Active Directory
                                                                                                      $ADPath="OU=$Division,OU=$City,$CompanyPath"
                                                                                                             # Create the user in Active Directory
                                                                                                                    New-ADUser -GivenName $Firstname -Surname $Lastname -DisplayName $Displayname -UserPrincipalName $UserPN -Division $Division -City $City -Path $ADPath -name $Displayname -SamAccountName $Sam -userpassword (GENERATEPASSWORD)
