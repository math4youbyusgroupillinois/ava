...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'ava_test_email_emailtemplate', 'body')

        # Adding field 'EmailTemplate.message'
        db.add_column(u'ava_test_email_emailtemplate', 'message',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'ava_test_email_emailtemplate', 'body',
                      self.gf('django.db.models.fields.TextField')(default=2),
                      keep_default=False)

        # Deleting field 'EmailTemplate.message'
        db.delete_column(u'ava_test_email_emailtemplate', 'message')
