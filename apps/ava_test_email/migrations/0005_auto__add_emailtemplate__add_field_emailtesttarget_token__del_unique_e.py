...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'EmailTestTarget', fields ['emailtest', 'target']
        db.delete_unique(u'ava_test_email_emailtesttarget', ['emailtest_id', 'target_id'])

        # Adding model 'EmailTemplate'
        db.create_table(u'ava_test_email_emailtemplate', (
        ...
        db.send_create_signal(u'ava_test_email', ['EmailTemplate'])

        # Adding field 'EmailTestTarget.token'
        db.add_column(u'ava_test_email_emailtesttarget', 'token',
                      self.gf('django.db.models.fields.CharField')(default=2, unique=True, max_length=100),
                      keep_default=False)

        # Adding unique constraint on 'EmailTestTarget', fields ['emailtest', 'target', 'token']
        db.create_unique(u'ava_test_email_emailtesttarget', ['emailtest_id', 'target_id', 'token'])


    def backwards(self, orm):
        # Removing unique constraint on 'EmailTestTarget', fields ['emailtest', 'target', 'token']
        db.delete_unique(u'ava_test_email_emailtesttarget', ['emailtest_id', 'target_id', 'token'])

        # Deleting model 'EmailTemplate'
        db.delete_table(u'ava_test_email_emailtemplate')

        # Deleting field 'EmailTestTarget.token'
        db.delete_column(u'ava_test_email_emailtesttarget', 'token')

        # Adding unique constraint on 'EmailTestTarget', fields ['emailtest', 'target']
        db.create_unique(u'ava_test_email_emailtesttarget', ['emailtest_id', 'target_id'])
