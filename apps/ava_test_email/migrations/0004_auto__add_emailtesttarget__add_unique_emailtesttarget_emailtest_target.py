...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailTestTarget'
        db.create_table(u'ava_test_email_emailtesttarget', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('emailtest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_test_email.EmailTest'])),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_core_people.Identifier'])),
        ))
        db.send_create_signal(u'ava_test_email', ['EmailTestTarget'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EmailTestTarget'
        db.delete_table(u'ava_test_email_emailtesttarget')
    ...
    models = {
        ...
        u'ava_test_email.emailtesttarget': {
            'Meta': {'unique_together': "(('emailtest', 'target'),)", 'object_name': 'EmailTestTarget'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
