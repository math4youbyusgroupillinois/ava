...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EmailTest.user'
        db.delete_column(u'ava_test_email_emailtest', 'user_id')

        # Deleting field 'EmailTest.id'
        db.delete_column(u'ava_test_email_emailtest', u'id')

        # Deleting field 'EmailTest.created'
        db.delete_column(u'ava_test_email_emailtest', 'created')

        # Deleting field 'EmailTest.modified'
        db.delete_column(u'ava_test_email_emailtest', 'modified')

        # Deleting field 'EmailTest.test'
        db.delete_column(u'ava_test_email_emailtest', 'test_id')

        # Deleting field 'EmailTest.testtype'
        db.delete_column(u'ava_test_email_emailtest', 'testtype_id')

        # Adding field 'EmailTest.test_ptr'
        db.add_column(u'ava_test_email_emailtest', u'test_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=2, to=orm['ava_test.Test'], unique=True, primary_key=True),
                      keep_default=False)

        # Adding field 'EmailTest.emailtesttype'
        db.add_column(u'ava_test_email_emailtest', 'emailtesttype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['ava_test_email.EmailTestType']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EmailTest.user'
        db.add_column(u'ava_test_email_emailtest', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'EmailTest.id'
        db.add_column(u'ava_test_email_emailtest', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=2, primary_key=True),
                      keep_default=False)

        # Adding field 'EmailTest.created'
        db.add_column(u'ava_test_email_emailtest', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=2, blank=True),
                      keep_default=False)

        # Adding field 'EmailTest.modified'
        db.add_column(u'ava_test_email_emailtest', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=2, blank=True),
                      keep_default=False)

        # Adding field 'EmailTest.test'
        db.add_column(u'ava_test_email_emailtest', 'test',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['ava_test.Test']),
                      keep_default=False)

        # Adding field 'EmailTest.testtype'
        db.add_column(u'ava_test_email_emailtest', 'testtype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['ava_test_email.EmailTestType']),
                      keep_default=False)

        # Deleting field 'EmailTest.test_ptr'
        db.delete_column(u'ava_test_email_emailtest', u'test_ptr_id')

        # Deleting field 'EmailTest.emailtesttype'
        db.delete_column(u'ava_test_email_emailtest', 'emailtesttype_id')
