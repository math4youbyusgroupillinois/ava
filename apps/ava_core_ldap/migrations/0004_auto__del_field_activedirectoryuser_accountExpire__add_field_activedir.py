...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActiveDirectoryUser.accountExpire'
        db.delete_column(u'ava_core_ldap_activedirectoryuser', 'accountExpire')

        # Adding field 'ActiveDirectoryUser.accountExpires'
        db.add_column(u'ava_core_ldap_activedirectoryuser', 'accountExpires',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ActiveDirectoryUser.accountExpire'
        db.add_column(u'ava_core_ldap_activedirectoryuser', 'accountExpire',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=300),
                      keep_default=False)

        # Deleting field 'ActiveDirectoryUser.accountExpires'
        db.delete_column(u'ava_core_ldap_activedirectoryuser', 'accountExpires')
    ...
    models = {
        ...
        u'ava_core_ldap.activedirectoryuser': {
            ...
            'accountExpires': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
