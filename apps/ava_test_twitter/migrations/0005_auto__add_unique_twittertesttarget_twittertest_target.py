...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TwitterTestTarget', fields ['twittertest', 'target']
        db.create_unique(u'ava_test_twitter_twittertesttarget', ['twittertest_id', 'target_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TwitterTestTarget', fields ['twittertest', 'target']
        db.delete_unique(u'ava_test_twitter_twittertesttarget', ['twittertest_id', 'target_id'])
    ...
    models = {
        ...
        u'ava_test_twitter.twittertesttarget': {
            'Meta': {'unique_together': "(('twittertest', 'target'),)", 'object_name': 'TwitterTestTarget'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
