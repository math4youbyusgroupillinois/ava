...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ava_test_twitter_twitteraccount', (
            ...
            ('password_enc', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'ava_test_twitter', ['TwitterAccount'])

        # Adding model 'TweetLink'
        db.create_table(u'ava_test_twitter_tweetlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
        ...
        db.send_create_signal(u'ava_test_twitter', ['TweetLink'])
        ...
        # Adding model 'TweetTemplate'
        db.create_table(u'ava_test_twitter_tweettemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('help_text', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('tweet', self.gf('django.db.models.fields.TextField')(max_length=140)),
        ))
        db.send_create_signal(u'ava_test_twitter', ['TweetTemplate'])

        # Adding model 'TwitterTestType'
        db.create_table(u'ava_test_twitter_twittertesttype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
        ...
        db.send_create_signal(u'ava_test_twitter', ['TwitterTestType'])

        # Adding model 'TwitterTest'
        db.create_table(u'ava_test_twitter_twittertest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('test', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_test.Test'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('testtype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_test_twitter.TwitterTestType'])),
            ('tweet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_test_twitter.TweetTemplate'])),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_test_twitter.TweetLink'])),
        ))
        db.send_create_signal(u'ava_test_twitter', ['TwitterTest'])


    def backwards(self, orm):
        # Deleting model 'TwitterAccount'
        db.delete_table(u'ava_test_twitter_twitteraccount')

        # Deleting model 'TweetLink'
        db.delete_table(u'ava_test_twitter_tweetlink')

        # Deleting model 'TwitterMessageType'
        db.delete_table(u'ava_test_twitter_twittermessagetype')

        # Deleting model 'TweetTemplate'
        db.delete_table(u'ava_test_twitter_tweettemplate')

        # Deleting model 'TwitterTestType'
        db.delete_table(u'ava_test_twitter_twittertesttype')

        # Deleting model 'TwitterTest'
        db.delete_table(u'ava_test_twitter_twittertest')
    ...
    models = {
        ...
        u'ava_test_twitter.twittermessagetype': {
            'Meta': {'object_name': 'TwitterMessageType'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'help_text': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'ava_test_twitter.twittertest': {
            ...
            'testtype': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ava_test_twitter.TwitterTestType']"}),
