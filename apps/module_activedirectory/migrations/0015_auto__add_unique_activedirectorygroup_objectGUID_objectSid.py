...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'module_activedirectory_activedirectorygroup', ['objectGUID', 'objectSid'])


    def backwards(self, orm):
        # Removing unique constraint on 'ActiveDirectoryGroup', fields ['objectGUID', 'objectSid']
        db.delete_unique(u'module_activedirectory_activedirectorygroup', ['objectGUID', 'objectSid'])
