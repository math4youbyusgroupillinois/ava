...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QueryParameters.user'
        db.add_column(u'module_activedirectory_queryparameters', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QueryParameters.user'
        db.delete_column(u'module_activedirectory_queryparameters', 'user_id')
