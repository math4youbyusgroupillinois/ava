...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ActiveDirectoryPerson', fields ['dn']
        db.create_unique(u'module_activedirectory_activedirectoryperson', ['dn'])

        # Adding unique constraint on 'ActiveDirectoryGroup', fields ['distinguishedName']
        db.create_unique(u'module_activedirectory_activedirectorygroup', ['distinguishedName'])

        # Adding unique constraint on 'QueryParameters', fields ['user', 'server', 'user_dn']
        db.create_unique(u'module_activedirectory_queryparameters', ['user_id', 'server', 'user_dn'])


    def backwards(self, orm):
        # Removing unique constraint on 'QueryParameters', fields ['user', 'server', 'user_dn']
        db.delete_unique(u'module_activedirectory_queryparameters', ['user_id', 'server', 'user_dn'])

        # Removing unique constraint on 'ActiveDirectoryGroup', fields ['distinguishedName']
        db.delete_unique(u'module_activedirectory_activedirectorygroup', ['distinguishedName'])

        # Removing unique constraint on 'ActiveDirectoryPerson', fields ['dn']
        db.delete_unique(u'module_activedirectory_activedirectoryperson', ['dn'])
    ...
    models = {
        ...
        u'module_activedirectory.activedirectoryperson': {
            ...
            'dn': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '300'}),
