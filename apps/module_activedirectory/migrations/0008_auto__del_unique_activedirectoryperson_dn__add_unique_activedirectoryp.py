...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ActiveDirectoryPerson', fields ['displayName']
        db.create_unique(u'module_activedirectory_activedirectoryperson', ['displayName'])


    def backwards(self, orm):
        # Removing unique constraint on 'ActiveDirectoryPerson', fields ['displayName']
        db.delete_unique(u'module_activedirectory_activedirectoryperson', ['displayName'])
    ...
    models = {
        ...
        u'module_activedirectory.activedirectoryperson': {
            ...
            'displayName': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '300'}),
