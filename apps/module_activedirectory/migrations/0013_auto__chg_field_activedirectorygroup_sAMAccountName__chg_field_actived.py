...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActiveDirectoryGroup.sAMAccountName'
        db.alter_column(u'module_activedirectory_activedirectorygroup', 'sAMAccountName', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'ActiveDirectoryGroup.objectCategory'
        db.alter_column(u'module_activedirectory_activedirectorygroup', 'objectCategory', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'ActiveDirectoryGroup.sAMAccountName'
        db.alter_column(u'module_activedirectory_activedirectorygroup', 'sAMAccountName', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'ActiveDirectoryGroup.objectCategory'
        db.alter_column(u'module_activedirectory_activedirectorygroup', 'objectCategory', self.gf('django.db.models.fields.CharField')(max_length=30))
