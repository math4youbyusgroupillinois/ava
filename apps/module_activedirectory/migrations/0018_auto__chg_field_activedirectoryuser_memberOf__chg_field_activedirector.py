...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActiveDirectoryUser.memberOf'
        db.alter_column(u'module_activedirectory_activedirectoryuser', 'memberOf_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['module_activedirectory.ActiveDirectoryGroup'], null=True))

        # Changing field 'ActiveDirectoryGroup.member'
        db.alter_column(u'module_activedirectory_activedirectorygroup', 'member_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['module_activedirectory.ActiveDirectoryUser'], null=True))

    def backwards(self, orm):

        # Changing field 'ActiveDirectoryUser.memberOf'
        db.alter_column(u'module_activedirectory_activedirectoryuser', 'memberOf_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['module_activedirectory.ActiveDirectoryGroup']))

        # Changing field 'ActiveDirectoryGroup.member'
        db.alter_column(u'module_activedirectory_activedirectorygroup', 'member_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['module_activedirectory.ActiveDirectoryUser']))
    ...
    models = {
        ...
        u'module_activedirectory.activedirectorygroup': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['module_activedirectory.ActiveDirectoryUser']", 'null': 'True'}),
        ...
        u'module_activedirectory.activedirectoryuser': {
            ...
            'memberOf': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['module_activedirectory.ActiveDirectoryGroup']", 'null': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
