...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveDirectoryUser.distinguishedName'
        db.add_column(u'module_activedirectory_activedirectoryuser', 'distinguishedName',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActiveDirectoryUser.distinguishedName'
        db.delete_column(u'module_activedirectory_activedirectoryuser', 'distinguishedName')
    ...
    models = {
        ...
        u'module_activedirectory.activedirectorygroup': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['module_activedirectory.ActiveDirectoryUser']", 'symmetrical': 'False'}),
        ...
        u'module_activedirectory.activedirectoryuser': {
            ...
            'memberOf': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['module_activedirectory.ActiveDirectoryGroup']", 'symmetrical': 'False'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
