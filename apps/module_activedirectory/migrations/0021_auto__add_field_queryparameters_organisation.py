...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QueryParameters.organisation'
        db.add_column(u'module_activedirectory_queryparameters', 'organisation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['ava_core_org.Organisation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QueryParameters.organisation'
        db.delete_column(u'module_activedirectory_queryparameters', 'organisation_id')
