...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'module_activedirectory_activedirectoryuser', 'memberOf',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['module_activedirectory.ActiveDirectoryGroup'], null=True),
                      keep_default=False)
        ...
        db.add_column(u'module_activedirectory_activedirectorygroup', 'member',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['module_activedirectory.ActiveDirectoryUser'], null=True),
                      keep_default=False)
