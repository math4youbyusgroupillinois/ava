...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestType.url'
        db.add_column(u'ava_test_testtype', 'url',
                      self.gf('django.db.models.fields.TextField')(default=2, max_length='50'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestType.url'
        db.delete_column(u'ava_test_testtype', 'url')
