...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ava_test_testtype', (
        ...
        db.send_create_signal(u'ava_test', ['TestType'])
        ...
        # Adding model 'TimingType'
        db.create_table(u'ava_test_timingtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
        ...
        db.send_create_signal(u'ava_test', ['TimingType'])

        # Adding model 'Test'
        db.create_table(u'ava_test_test', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('testtype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_test.TestType'])),
            ('timingtype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_test.TimingType'])),
            ('targettype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_test.TargetType'])),
        ))
        db.send_create_signal(u'ava_test', ['Test'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'ava_test_testtype')
        ...
        # Deleting model 'TimingType'
        db.delete_table(u'ava_test_timingtype')

        # Deleting model 'Test'
        db.delete_table(u'ava_test_test')
    ...
    models = {
        ...
        u'ava_test.test': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'targettype': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ava_test.TargetType']"}),
        ...
        u'ava_test.testtargetsorg': {
            'Meta': {'object_name': 'TestTargetsOrg'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'targetid': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ava_core_org.Organisation']"}),
            'test': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ava_test.Test']"})
        },
        u'ava_test.testtargetspeople': {
            'Meta': {'object_name': 'TestTargetsPeople'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'targetid': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ava_core_people.Person']"}),
            'test': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ava_test.Test']"})
        },
        u'ava_test.testtargetsproject': {
            'Meta': {'object_name': 'TestTargetsProject'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'targetid': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ava_core_project.Project']"}),
            'test': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ava_test.Test']"})
        },
        u'ava_test.testtype': {
