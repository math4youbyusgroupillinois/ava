...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.project'
        db.add_column(u'ava_core_org_organisation', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['ava_core_project.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.project'
        db.delete_column(u'ava_core_org_organisation', 'project_id')
