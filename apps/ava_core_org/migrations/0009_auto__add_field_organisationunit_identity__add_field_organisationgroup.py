...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganisationUnit.identity'
        db.add_column(u'ava_core_org_organisationunit', 'identity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_core_identity.Identity'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'OrganisationGroup.identity'
        db.add_column(u'ava_core_org_organisationgroup', 'identity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_core_identity.Identity'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganisationUnit.identity'
        db.delete_column(u'ava_core_org_organisationunit', 'identity_id')

        # Deleting field 'OrganisationGroup.identity'
        db.delete_column(u'ava_core_org_organisationgroup', 'identity_id')
    ...
    models = {
        ...
        u'ava_core_people.person': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ava_core_identity.Identity']", 'null': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ava_core_project.Project']"}),
