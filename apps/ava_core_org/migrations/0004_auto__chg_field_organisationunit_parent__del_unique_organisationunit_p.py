...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'OrganisationUnit', fields ['parent']
        db.delete_unique(u'ava_core_org_organisationunit', ['parent_id'])


        # Changing field 'OrganisationUnit.parent'
        db.alter_column(u'ava_core_org_organisationunit', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_core_org.OrganisationUnit'], null=True))

    def backwards(self, orm):

        # Changing field 'OrganisationUnit.parent'
        db.alter_column(u'ava_core_org_organisationunit', 'parent_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ava_core_org.OrganisationUnit'], unique=True, null=True))
        # Adding unique constraint on 'OrganisationUnit', fields ['parent']
        db.create_unique(u'ava_core_org_organisationunit', ['parent_id'])
