...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.user'
        db.add_column(u'ava_core_org_organisation', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.user'
        db.delete_column(u'ava_core_org_organisation', 'user_id')
