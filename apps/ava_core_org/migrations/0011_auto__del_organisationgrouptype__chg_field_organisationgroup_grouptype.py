...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'OrganisationGroup.grouptype' to match new field type.
        db.rename_column(u'ava_core_org_organisationgroup', 'grouptype_id', 'grouptype')
        # Changing field 'OrganisationGroup.grouptype'
        db.alter_column(u'ava_core_org_organisationgroup', 'grouptype', self.gf('django.db.models.fields.CharField')(max_length=5))
        # Removing index on 'OrganisationGroup', fields ['grouptype']
        db.delete_index(u'ava_core_org_organisationgroup', ['grouptype_id'])


    def backwards(self, orm):
        # Adding index on 'OrganisationGroup', fields ['grouptype']
        db.create_index(u'ava_core_org_organisationgroup', ['grouptype_id'])
        ...
        # Renaming column for 'OrganisationGroup.grouptype' to match new field type.
        db.rename_column(u'ava_core_org_organisationgroup', 'grouptype', 'grouptype_id')
        # Changing field 'OrganisationGroup.grouptype'
        db.alter_column(u'ava_core_org_organisationgroup', 'grouptype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_core_org.OrganisationGroupType']))
